<?php
/**
 * Returns the into string into an ASCII string
 * Using the characters map provided by jbroadway's URLify
 *
 * @author Marc Teinturier <m@m-te.fr>
 * @version 0.1
 * @see https://github.com/jbroadway/urlify
 */
...
{
    /**
     * Characters map for replacements
     *
     * @var array $maps
     */
    ...
    /**
     * Compile the characters and remplacements
     */
    private static function compileMap()
    {
        if(count(self::$map) === 0) {
    ...
    /**
     * Add a new set of characters for replacement
     *
     * @param array $map Associative array source => replacement
    ...
    /**
     * Translate the input string into an Ascii string
     *
     * @param $string
     * @return string
     */
        ...
        if (preg_match_all (self::$regex, $string, $matches)) {
            for ($i = 0; $i < count ($matches[0]); $i++) {
                ...
                if (isset (self::$map[$char])) {
                    $string = str_replace ($char, self::$map[$char], $string);
                }
            }
        }
        return $string;
